#!/usr/bin/env python3
"""
YOLOv8 Model Validation Script

Validates a trained YOLOv8 model and displays:
...
def find_models():
    """Scan runs/detect for trained models."""
    ...
    for subdir in sorted(RUNS_DIR.iterdir()):
        ...
        for pt_name in ("best.pt", "last.pt"):
            ...
            if pt.exists():
                ...
                break  # prefer best.pt; skip last.pt if best exists
...
def main():
    print("\n" + "=" * 80)
    print("  YOLOv8 MODEL VALIDATION & ANALYSIS TOOL")
    print("=" * 80)
    ...
    results_dir = weights_path.parent.parent / "val"
